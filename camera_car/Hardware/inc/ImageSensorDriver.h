#ifndef IMAGESENSORDRIVER_H
#define IMAGESENSORDRIVER_H

#include "common.h"
#include "SCCB.h"
#include "MK60_DMA.h"

#define USINGCAMERA             0                 //使用摄像头定义，目前只能为0，即OV7725

#define ImgPCLK_port            PORTA_BASE_PTR
#define ImgPCLK_GPIO_port       PTA_BASE_PTR
#define ImgPCLK_pin             25
#define ImgVSY_port             PORTA_BASE_PTR
#define ImgVSY_GPIO_port        PTA_BASE_PTR
#define ImgVSY_pin              29
#define ImgHREF_port            PORTA_BASE_PTR
#define ImgHREF_GPIO_port       PTA_BASE_PTR
#define ImgHREF_pin             27
#define ImgDATA_port            PORTB_BASE_PTR
#define ImgDATA_GPIO_port       PTB_BASE_PTR


/************************************************************/
/*器件寄存器*/
/************************************************************/
#define OV7725ADDR       0x21
